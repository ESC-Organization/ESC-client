...
import Lv4 from '/src/assets/images/avatar/level/lv4.png';
import Box4 from '/src/assets/images/complete/box4.png';
...
export default function Finish() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-[59%]">
          <img src={Lv4} className="animate-rotate-axis transform-style-3d" />
        </div>
      </div>
