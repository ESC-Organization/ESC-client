...
import Lv5 from '/src/assets/images/avatar/level/lv5.png';
import Box5 from '/src/assets/images/complete/box5.png';
...
export default function Finish() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-[59%]">
          <img src={Lv5} className="animate-rotate-axis transform-style-3d" />
        </div>
      </div>
      <div className="w-full flex justify-center h-[50%] absolute top-[10%] p-4 max-w-[500px] space-y-4">
        <div className={`w-full transform transition-transform duration-500`}>
          <BlackBox text="성하예프의 가호가 담긴 '통신짱짱 무전기'를 얻었다!" />
        </div>
      </div>
